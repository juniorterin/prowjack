...
// Completely fresh IDs not used anywhere yet
const gaps = {
  'genre_giallo': [
    {title:'Death Steps in the Dark',year:1977,imdbId:'tt0076073'},
  ],
  'genre_folk_horror': [
    {title:'Errementari: The Blacksmith and the Devil',year:2017,imdbId:'tt6862916'},
    {title:'The Reflecting Skin',year:1990,imdbId:'tt0100378'},
    {title:'Ravenous',year:1999,imdbId:'tt0129332'},
    {title:'Cellar Dweller',year:1988,imdbId:'tt0094810'},
    {title:'The Innkeepers',year:2011,imdbId:'tt1594562'},
  ],
  'genre_body_horror': [
...
for (const [f, adds] of Object.entries(gaps)) {
  ...
  const ok = seen.size >= 100 ? 'OK' : 'SHORT(' + (100 - seen.size) + ')';
  console.log(f + ': ' + seen.size + ' [' + ok + ']');
}
